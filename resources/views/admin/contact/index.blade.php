         ...
         <form action="{{ route('admin.contact.update', 1) }}" method="POST">
                ...
                <div class="mb-4 p-3 border rounded bg-white">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="2">{{ $contact->description }}</textarea>
                    </div>
                </div>
                <!-- Adres Bilgisi -->
                <div class="mb-4 p-3 border rounded bg-white">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control"  name="adres_title" value="{{ $contact->adres_title }}">
                    </div>
                    <div class="form-group">
                        <label for="address_description" style="font-weight: 500;">Adres Açıklaması</label>
                        <textarea class="form-control" name="adres_description" rows="2">{{ $contact->adres_description }}</textarea>
                    </div>
                </div>
                <!-- İletişim Numarası -->
                <div class="mb-4 p-3 border rounded bg-white">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control"  name="phone_description" rows="2">{{ $contact->phone_description }}</textarea>
                    </div>
                </div>
                <!-- Açılış Saatleri -->
                <div class="mb-4 p-3 border rounded bg-white">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" name="hour_title" value="{{ $contact->hour_title }}">
                    </div>
                    <div class="form-group">
                        <label for="opening_description" style="font-weight: 500;">Açılış Saatleri Açıklaması</label>
                        <textarea class="form-control"  name="hour_description" rows="2">{{ $contact->hour_description }}</textarea>
                    </div>
                </div>
